...
until sudo wget -O /var/www/html/index.php https://raw.githubusercontent.com/wwce/terraform/master/gcp/adv_peering_4fw_transit/v12/bootstrap_files/showheaders.php; do echo "Retrying"; sleep 2; done
