...
module "fw_outbound" {
  ...
  zones                 = var.zones
  subnetworks           = [module.vpc_trust.subnetwork_self_link[0], module.vpc_mgmt.subnetwork_self_link[0], module.vpc_untrust.subnetwork_self_link[0]]
...
#-----------------------------------------------------------------------------------------------
# Create default route to ILB. Route will be exported to spokes via GCP peering.
