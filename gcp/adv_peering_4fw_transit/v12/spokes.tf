#-----------------------------------------------------------------------------------------------
# Create spoke-1 VPC, 2 web-servers, internal load balancer, and peering links to trust VPC
module "vpc_spoke1" {
  source               = "./modules/vpc/"
  vpc                  = var.spoke1_vpc
...
#-----------------------------------------------------------------------------------------------
# Create spoke-1 VPC, 1 VM instance, and peering links to trust VPC
module "vpc_spoke2" {
  source               = "./modules/vpc/"
  vpc                  = var.spoke2_vpc
