...
cd /var/tmp
wget https://raw.githubusercontent.com/wwce/terraform/master/aws/Jenkins_proj-master/attacker/Dockerfile
wget https://raw.githubusercontent.com/wwce/terraform/master/aws/Jenkins_proj-master/attacker/docker-compose.yml
